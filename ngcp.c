...
struct msg_fake_sip *ngcp_parser(const u_char *payload,
  ...
  if ((comm = strstr((const char *)payload, "offer")) != NULL) {
    ...
    // fprintf(stderr, "Only OFFER, ANSWER or DELETE command are supported -
    // abort!\n");
    return NULL;
  }
  ...
  if (flag != DELETE) {
    ...
    // sdp length
    u_int16_t sdp_len =
        (100 * (sdp[3] - '0')) + (10 * (sdp[4] - '0')) + (sdp[5] - '0');
    ...
    */
    ...
    if (cnt == 1)
      ...
      a_number_len = (100 * (a_number[0] - '0')) + (10 * (a_number[1] - '0')) +
                     (a_number[2] - '0');
    ...
    */
    ...
    if (cnt == 1)
      ...
      b_number_len = (100 * (b_number[0] - '0')) + (10 * (b_number[1] - '0')) +
                     (b_number[2] - '0');
    ...
    */
    ...
    if (cnt == 1)
      ...
      from_tag_len = (100 * (from_tag[0] - '0')) + (10 * (from_tag[1] - '0')) +
                     (from_tag[2] - '0');
    ...
    */
    if (flag == ANSWER) {
      ...
      if (cnt == 1)
        ...
        to_tag_len = (100 * (to_tag[0] - '0')) + (10 * (to_tag[1] - '0')) +
                     (to_tag[2] - '0');
