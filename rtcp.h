...
#define SENDER_REPORT_JSON                                                     \
  "\"sender_information\":{\"ntp_timestamp_sec\":%u,\"ntp_timestamp_usec\":%"  \
  "u,\"octets\":%u,\"rtp_timestamp\":%u, \"packets\":%u},"
#define REPORT_BLOCK_JSON                                                      \
  "\"ssrc\":%u,\"type\":%u, \"report_blocks\":[{\"source_ssrc\":%u,\"highest_seq_no\":%u,\"fraction_lost\":%u,\"ia_jitter\":%u,\
\"packets_lost\":%u,\"lsr\":%u,\"dlsr\":%u}],\"report_count\":1,"

#define SDES_REPORT_BEGIN_JSON                                                 \
  "\"sdes_ssrc\":%u,\"sdes_chunk_ssrc\":%u,\"sdes_information\": [ "
#define SDES_REPORT_INFO_JSON "{\"type\":%u,\"text\":\"%.*s\"},"
#define SDES_REPORT_END_JSON "],\"sdes_report_count\":%u,"

#define EXTENDED_REPORT_JSON                                                   \
  "\"extended_report_information\":{\"type\":%u, \"identifier\":%u, "          \
  "\"loss_rate\":%u, \"discard_rate\":%u, \"burst_rate\":%u, "                 \
  "\"gap_rate\":%u, \"burst_duration\":%u, \"gap_duration\":%u, "              \
  "\"round_trip_delay\":%u, \"end_sys_delay\":%u, \"signal_lev\":%u, "         \
  "\"noise_lev\":%u, \"RERL\":%u, \"Gmin\":%u, \"R_fact\":%u, "                \
  "\"ext_R_fact\":%u, \"MOS_LQ\":%u, \"MOS_CQ\":%u, "                          \
  "\"RX_conf\":[{\"PLC\":%u, \"JB_adapt\":%u, \"JB_rate\":%u}], "              \
  "\"JB_nom\":%u, \"JB_max\":%u, \"JB_abs_max\":%u}"
